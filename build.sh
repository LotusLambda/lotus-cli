...
-H:+ReportUnsupportedElementsAtRuntime -H:+ReportExceptionStackTraces -H:ReflectionConfigurationFiles=./reflection.json -cp ./build/libs/lotus-cli-1.0-all.jar -H:Class=MainKt -H:Name=lotus-cli
